...
VARIABLES config,         \* The current configuration
          ...
          fetch_state,    \* Tracks the state of fetching as a follower
...
logVars == <<log, hwm>>
serverVars == <<config, current_epoch, role, state, voted_for, leader, fetch_state, pending_ack>>
